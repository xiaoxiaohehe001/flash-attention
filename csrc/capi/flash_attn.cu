...
void set_params_fprop(Flash_fwd_params &params,
                      ...
                      void * const chunked_seq_lens_q_d,
                      void * const chunked_seq_lens_k_d,
                      void * const p_d,
    ...
    params.chunked_seq_lens_q = static_cast<int *>(chunked_seq_lens_q_d);
    params.chunked_seq_lens_k = static_cast<int *>(chunked_seq_lens_k_d);
...
void set_params_dgrad(Flash_bwd_params &params,
    ...
    set_params_fprop(params,
                     ...
                     cu_seqlens_q_d,
                     cu_seqlens_k_d,
                     chunked_seq_lens_q_d,
                     chunked_seq_lens_k_d,
                     nullptr,
                     softmax_lse_d,
                     p_dropout,
                     softmax_scale,
...
bool flash_attn_fwd(const void * const q,
    ...
    set_params_fprop(params,
                     ...
                     /*chunked_seqlens_q_d=*/nullptr,
                     /*chunked_seqlens_k_d=*/nullptr,
...
bool flash_attn_varlen_fwd(const void * const q,
                           ...
                           const int32_t * const chunked_seq_lens_q,
                           const int32_t * const chunked_seq_lens_k,
                           void * const rng_state,
                           void * const out,
                           void * const softmax_ptr,
                           void * const softmax_lse_ptr,
    ...
    set_params_fprop(params,
                     ...
                     const_cast<int32_t *>(chunked_seq_lens_q),
                     const_cast<int32_t *>(chunked_seq_lens_k),
                     return_softmax ? softmax_ptr : nullptr,
                     softmax_lse_ptr,
                     p_dropout,
                     softmax_scale,
...
bool flash_attn_varlen_bwd(const void * const dout,
                           ...
                           const int32_t * const cu_seqlens_q,
                           const int32_t * const cu_seqlens_k,
                           const int32_t * const cu_seqlens_offset_q,
                           const int32_t * const cu_seqlens_offset_k,
                           void * const rng_state,
                           void * const dq,
                           void * const dk,
                           void * const dv,
...
bool calc_reduced_attn_scores(const void * const q,
    ...
    set_params_fprop(params,
                     batch_size, seqlen_q, seqlen_k, 0, 0, num_heads, num_heads_k, head_size, 0,
                     const_cast<void *>(q), 
                     const_cast<void *>(k),
                     nullptr, 
